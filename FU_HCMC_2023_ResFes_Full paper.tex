...
\title{FU HCMC ResFes Paper Title}
...
email address or ORCID}
\and
\IEEEauthorblockN{6\textsuperscript{th} Suppervisor Name}
\IEEEauthorblockA{\textit{dept. name of organization (of Aff.)} \\
\textit{name of organization (of Aff.)}\\
City, Country \\
email address or ORCID}
...
\end{itemize}
An excellent style manual for science writers is \cite{Bhandari2018}.
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=3.5 in]{FPTU_logo.png}}
...
\section{Conclusions}
Summarize your key findings, suggest future areas for research.
